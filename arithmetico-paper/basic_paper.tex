...
\title{Unsigned Natural-Number Wavefront Propagation and Emergent Euclidean Geometry}
...
\section{Minimalism and Hardware Affinity}

The model is minimal: each cell requires only a single unsigned integer. It avoids floating-point arithmetic, square roots, divisions, and global operations, making it highly suitable for FPGA cellular automata fabrics, GPU kernels, and other massively parallel architectures.

\section{Relation to Existing Work}

The approach shares conceptual ground with Euclidean distance transforms, fast marching methods, and Dijkstra-style propagation, yet differs fundamentally by reconstructing the exact quadratic metric through local unsigned increments rather than approximations or priority queues.
